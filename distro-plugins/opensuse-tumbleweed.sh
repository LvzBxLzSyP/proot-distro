...
bootstrap_distribution() {
	...
	opensuse_manifest=$(docker manifest inspect "opensuse/tumbleweed")
...
write_plugin() {
	...
	DISTRO_COMMENT="Tumbleweed (rolling release). Only aarch64 and x86_64 architectures supported."
